        ...
        <section className="app__aboutus app__bg flex__center section__padding" id="section2">
            ...
            <div className="app__aboutus-content flex__center">
                <div className="app__aboutus-content_about">
                    ...
                    <Fade duration={2800} distance={'60px'} right><button type="button" className="btn border border-blue-900 dark:border-gray-500 text-blue-600 dark:text-gray-400">Know More</button></Fade>
                </div>
                ...
                <div className="app__aboutus-content_history">
                    ...
                    <Fade duration={2800} distance={'60px'} left><button type="button" className="btn bg-blue-500 dark:bg-gray-600 text-white dark:text-gray-900">Know More</button></Fade>
                </div>
            </div>
        </section>

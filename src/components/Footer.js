...
export default function Footer() {
    return(
        <section className="app__footer section__padding dark:text-gray-400" id="section5">
            ...
            <Fade duration={2800} distance={'60px'} right><div className="app__newsletter">
            ...
            <div className="app__footer-links_contact">
                <Fade duration={2800} distance={'60px'} bottom><h1 className="app__footer-headtext bg-bg-dark text-transparent dark:bg-bg-light bg-clip-text">Contact Us</h1></Fade>
            ...
            <div className="app__footer-links_logo flex flex-col items-center">
                ...
                <Fade duration={2800} distance={'60px'} bottom><p className="p__opensans">&quot;The best way to find yourself is to lose yourself in the service of others.&quot;</p></Fade>
                <Bounce duration={2800} distance={'60px'} left><img src={flames} className="spoon__img" alt="flames__img" style={{ marginTop: 15 }} /></Bounce>
            ...
            <div className="app__footer-links_work">
                <Fade duration={2800} distance={'60px'} bottom><h1 className="app__footer-headtext text-transparent bg-bg-dark dark:bg-bg-light bg-clip-text">Working Hours</h1></Fade>
                <Fade duration={2800} distance={'60px'} bottom><p className="p__opensans">Monday-Friday:</p></Fade>
                <Fade duration={2800} distance={'60px'} bottom><p className="p__opensans">08:00 am - 12:00 am</p></Fade>

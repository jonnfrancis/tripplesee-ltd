            ...
            <div className="section__padding app__wrapper bg-white dark:bg-dark" id="section1">
                <div className="lo">
                    ...
                    <div className="flex flex-row gap-6 mt-8 justify-center lg:justify-start items-center p-0">
                        <Fade duration={1500} distance={'60px'} delay={600} left><HashLink to="#whyBriquettes" smooth ><button className="btn text-white hover:text-blue-600 bg-blue-600 hover:bg-gray-300 dark:text-slate-800 dark:hover:text-blue-700 dark:bg-slate-400 dark:hover:bg-blue-400">Get Started</button></HashLink></Fade>
                ...
                <div className="hero mt-12 lg:ml-6 w-[100%] sm:w-[80%] ">
                    <Fade duration={1500} distance={'60px'} top delay={1200}><div className="hero-icon ">
                        <img className="heroo" src={bgPic} alt=""></img>
                    </div></Fade>
                    <Fade duration={1500} distance={'60px'} right delay={1000}><div className="hero--bg">
                    ...
                    </div></Fade><Fade duration={1500} distance={'60px'} left delay={1000}>
